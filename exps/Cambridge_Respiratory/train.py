#!/usr/bin/env python3
"""Recipe for training a symptom diagnostics model for the CS-Res-L dataset.
...
from prepare_respiratory_data import prepare_data
...
class DiagnosticsBrain(sb.Brain):
    ...
    def compute_objectives(self, predictions, batch, stage):
        ...
        # Compute the cost function: BCE for a healthy/symtomatic classification problem
