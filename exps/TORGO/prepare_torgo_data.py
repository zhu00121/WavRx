...
def prepare_data(
    ...
    Input:
    ---
    wav_folder: path to the folder where all audio files are stored. Default as './data_og/TORGO/wav/'
    metadata_path: path to the metadata file (.csv). Default as './data_og/TORGO/metadata/TORGO-metadata.csv'
