...
def split_metadata(metadata_df, ratio, random_seed):
    """
    User-independent split with each split contains similar class ratio
    """

    mask_1 = metadata_df['Cough-label'] == 'cough'
    mask_2 = metadata_df['Cough-label'] == 'non'
